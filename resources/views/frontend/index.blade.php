            ...
            <div class="coh2n cm5ip">
                                    ...
                                    <div class="cokkt czhnl c6kou cmd8n">
                                        <div class="cwkz1 c0qn4">
                                            <div class="cduop cb7bz cp1au c6rln cclz8">
                                                <div class="ctzpc">
                                                    <img src="
                                                @if ($job->employer_logo) {{ $job->employer_logo }}
                                                @else
                                                {{ asset('images/default.jpg') }} @endif
                                                "
                                                ...
                                                <div class="cycys cduop chu3i cyhe5 cb04d c966h clhjg">
                                                    <div>
                                                        ...
                                                        <div class="cmi0k">
                                                            <a class="cqdqx clt06 cznhr" target="__blank"
                                                                href="{{ route('job.single', ['uuid' => $job->uuid]) }}">
                                                                {{ $job->job_title }}</a>
                                                        </div>
                                                        <div class="c0zhl">
                                                            <a class="cfhya cy6kr ch6sm ceip1 cdxuw ce33e c7d26 c9eyc c4vrg ca6yp cww2f comjk cmwpt cv6oq"
                                                                href="#0">
                                                    ...
                                                    <div class="c8og8 co7yr cduop c40vg c16gq c56h7">
                                                        <div class="ct4vx cjjz8">
                                                            <a class="c40tu ce7qj c50eh c2fn4 cyky3 ctpla czwz3 c6kou"
                                                                wire:navigate
                                                                href="{{ route('job.single', ['uuid' => $job->uuid]) }}">
                                                                Apply Now
                                                                <span
                ...
                <div class="pagination">
                    @foreach ($jobs->getUrlRange(1, $jobs->lastPage()) as $page => $url)
                        <a class="page @if ($page === $jobs->currentPage()) active @endif" wire:navigate
                            href="{{ $url }}">{{ $page }}</a>
                    @endforeach
                </div>
