    ...
    <div class="cd11c">
        ...
        <div class="c8d05 c0ahj">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <h2 class="c6cl6 cuad0 cfibj clt06">Latest WordPress Jobs</h2>
                        ...
                        <div class="cduop cb7bz cp1au c6rln cclz8">
                            ...
                            <div class="cycys cduop chu3i cyhe5 cb04d c966h clhjg">
                                <div>
                                    ...
                                    <div class="cmi0k">
                                        <a target="__blank" class="cqdqx clt06 cznhr" href="{{ route('job.single',['uuid'=>$job['uuid']]) }}">
                                            {{ $job['job_title'] }}
                                        </a>
                                    </div>
                                    <div class="c0zhl">
                                ...
                                <div class="c8og8 co7yr cduop c40vg c16gq c56h7">
                                    <div class="ct4vx cjjz8">
                                        <a wire:navigate class="c40tu ce7qj c50eh c2fn4 cyky3 ctpla czwz3 c6kou" href="{{ route('job.single', ['uuid' => $job['uuid']]) }}">
                                            Apply Now 
                                            <span class="ce3ah ccolo cndda clfy9 comjk cmwpt c8bku">-&gt;</span>
                                        </a>
                                    </div>
